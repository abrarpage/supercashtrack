...
const cases: { input: string; description: string }[] = [
  ...
  { input: "15000 beli es krim", description: "expense sederhana" },
  { input: "+500000 gaji freelance", description: "income sederhana" },
  { input: "15000 beli es krim #makan", description: "expense + hashtag" },
  { input: "+500000 gaji freelance #gaji", description: "income + hashtag" },
